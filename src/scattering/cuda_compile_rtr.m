%===============================================================================
%> @brief Compile the mex cuda function coupling_matrix_multiply_rtr_CUDA.cu
%>
%> @param lmax (int): maximal degree used in the SVWF expansion
%>
%> @param verbose (boolean): be verbose in compilation output?
%===============================================================================
function cuda_compile_rtr(lmax, verbose)
fprintf(1,'compiling CUDA-code')

SRC_FILE = 'coupling_matrix_multiply_rtr_CUDA.cu';
